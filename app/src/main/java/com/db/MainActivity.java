...
import com.db.Controlador.UsuarioController;
import com.db.Modelos.Constants;
import com.db.Modelos.SesionSingleton;
import com.db.Modelos.Usuario;
import com.db.Vistas.AdminActivity;
import com.db.Vistas.OperarioActivity;
    ...
    private void alFinalizarLogin(String result) {
        ...
        try {
            if(usuarioEncontrado){
                ...
                se.setFkDelegacion(json_data.getInt("fk_delegacion"));
                ...
                if(usuario != null){
                    if(usuario.getNickname().equals(e_usuario.getText().toString().trim())){
                        ...
                        se.setFkDelegacion(usuario.getFkDelegacion());
